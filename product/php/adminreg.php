...
if (isset($_POST["submit"])) {
    ...
    try {
        ...
        echo "<script>window.location.replace('adminreg.php')</script>";
    }
}
...
<head>
    ...
    <title>TEMYRACLE | ADMIN Register</title>
</head>
...
<body>
    ...
    <div class="w3-padding-64 w3-container" style="background-color: white;">
        <div class="w3-card form-container w3-round-large">
            <form class="w3-container w3-white w3-padding-24 w3-round-large formco" name="insertForm" action="adminreg.php" method="post" onsubmit="return confirmDialogReg()" enctype="multipart/form-data">
